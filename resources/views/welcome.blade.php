...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        <div
            class="text-[13px] leading-[20px] flex-1 p-6 pb-12 lg:p-20 bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)]">
            <h1 class="mb-1 font-medium">Investments Tracker</h1>
            <p class="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                A web application to manage personal investments
            </p>
            <ul class="flex flex-col mb-4 lg:mb-6">
                <li class="flex items-center gap-4 py-2 relative">
                    Access the <a href="{{url('graphiql')}}"
                       class="font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433]">
                        GraphQL API
                    </a>
                </li>
            </ul>
